...
public class AsymCrypt implements Crypter{
    ...
    public String generate() {
        // Генерируются простые q и p, оба по 1024 бита
        ...
        // Случайно генерируется d - взаимнообратное для e по модулю n
        // e - открытый ключ, d - закрытый
        do {
    ...
    public String encrypt(String message) {
        ...
        // Возведение в степень открытым ключём каждого символа
        for(char ch : mesCh){
    ...
    public String decrypt(String message) {
        ...
        // Возведение в степень закрытым ключём каждого символа
        for (String enc : encs){
    ...
    // Задаются открытый ключ и основание
